...
<?php if (publicus_get_option('index_mode') != 'company'): ?>
    ...
    <div id="content" class="mt15 container">
        ...
        <div class="row row-cols-1">
            <div class="col-lg-<?php publicus_hide_sidebar_out('12', '8') ?> col-md-12 <?php publicus_open_box_animated('animated fadeInLeft') ?> ">
                <?php if (isset($paged) && $paged <= 1): $home_banner_ava = publicus_ava_home_banners(); if(is_array($home_banner_ava) && count($home_banner_ava)>0):?>
                    <div class="<?php publicus_open_box_animated('animated fadeInLeft') ?>">
                        <?php get_template_part('templates/module', 'banners') ?>
                    </div>
                <?php endif; ?>
                <?php endif; ?>
                <div class="<?php publicus_open_box_animated('animated fadeInLeft') ?>
                <?php echo publicus_post_style_list() ? '' : 'pr-0 pl-0' ?>">
                    <div>
