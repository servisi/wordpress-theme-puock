<div id="content" class="publicus-text">
    ...
    <div id="index-company" class="publicus-bg pt20">
        ...
        <div class="container mt50" id="prod-items">
            <h3 class="text-center"><?php echo publicus_get_option('company_product_title', '产品概览') ?></h3>
            <div class="row">
                <?php $products = publicus_get_option('company_products', []);
        ...
        <div class="container mt50" id="do-items">
            <h3 class="text-center"><?php echo publicus_get_option('company_do_title') ?></h3>
            <div class="row mt50">
                <div class="col-lg-5">
                    <div class="w-100 h-100 bgimg"
                         style='background-image: url("<?php echo publicus_get_option('company_do_img') ?>");'></div>
                </div>
                <div class="col-lg-7">
                    <?php $dos = publicus_get_option('company_dos', []);
                    foreach ($dos as $do): ?>
                        <div class="do-item">
                            <div class="icon">
