    ...
    <?php echo publicus_breadcrumbs(); while (have_posts()):the_post();?>
        <div id="page-empty">
            <div id="page-<?php the_ID() ?>" class="row row-cols-1">
                <div id="post-main" class="col-lg-<?php publicus_hide_sidebar_out('12','8') ?> col-md-12 <?php publicus_open_box_animated('animated fadeInLeft') ?> ">
                    <div class="p-block">
                        <div><h1 id="post-title" class="mb-0 publicus-text t-xxl"><?php the_title() ?></h1></div>
                        <div class="options p-flex-sbc mt20">
                            <div>
                                <?php if (!publicus_is_checked('hide_post_views')): ?>
                                <div class="option publicus-bg ta3 t-sm mr-1"><i class="fa-regular fa-eye mr-1"></i><span id="post-views"><?php publicus_get_post_views();  ?></span><span><?php _e('次阅读', PUBLICUS) ?></span></div>
                                <?php endif; ?>
                        ...
                        <div class="mt20 publicus-text <?php get_entry_content_class() ?>">
                            <?php the_content() ?>
                            <?php do_action('publicus_page_content_footer'); ?>
                            <?php
