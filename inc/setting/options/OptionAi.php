        ...
        return [
            ...
            'fields' => [
                ...
                [
                    ...
                    'type' => 'text',
                    'sdt' => publicus_get_option('openai_api_key'),
                ...
                [
                    ...
                    'type' => 'textarea',
                    'sdt' => publicus_get_option('openai_model_sys_content'),
                ...
                [
                    ...
                    'type' => 'switch',
                    'sdt' => publicus_is_checked('openai_stream'),
                ...
                [
                    ...
                    'type' => 'textarea',
                    'sdt' => publicus_get_option('openai_default_welcome_chat', '您好，欢迎使用智能AI助理'),
                    'tips' => '支持HTML代码',
                ],
                [
                    'id' => 'ai_draw_dall_e',
                    ...
                    'type' => 'switch',
                    'sdt' => publicus_is_checked('openai_dall_e'),
                ...
                [
                    ...
                    'type' => 'select',
                    'sdt' => publicus_get_option('ai_draw_dall_e_model', 'dall-e-2'),
                    'options' => [
                ...
                [
                    ...
                    'type' => 'select',
                    'sdt' => publicus_get_option('openai_dall_e_size', '512x512'),
                    'options' => [
                ...
                [
                    ...
                    'type' => 'switch',
                    'sdt' => publicus_is_checked('openai_guest_use'),
                ],
            ]
        ];
    }
